...
- [GitHub PR branch lifecycle](github-pr-branch-lifecycle.md) — verify merge state and refreshed main before recovering an automatically deleted PR head branch
