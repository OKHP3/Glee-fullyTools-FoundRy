# Changelog — Glee-fullyTools-FoundRy
...
### Changed
- PromptChain promoted to v2.0 with expanded PROMPT00–PROMPT05 definitions
...
### Added
- `ProjectFileHybridizer.v1.0` protocol canonized in system ledger
- CanonSeal growth-only lock applied to all ledgers (`ledger_growth_confirmed_v3_20250727`)
- FrankenTemplate series (a, ab, ae, c, e, g, h, i, j, k, m, n, o, q, r, s, t, u, v, y) for GPT instruction scaffolding
- GPT PulseBook Evaluation suite v1.4, v1.6, v1.7
...
### Added
- Repository established as relay FoundRy for the Glee-fully ecosystem
- `AGENTS.md` authority chain: OKHP3/OverKill-Hill → Glee-fullyTools-FoundRy → child repos
