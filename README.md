...
│
├── web-templates/         ← Webpage template assets for child repo sites
│   └── [HTML/CSS templates — NOT deployed from this workbench]
│
└── snapshots/             ← Point-in-time state captures (dated)
