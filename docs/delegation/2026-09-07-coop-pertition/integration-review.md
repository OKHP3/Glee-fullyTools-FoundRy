...
F11, F12, F15, F16, F18, F19, and F20. Their assigned additions were
...
- F14: the README was committed but the required pilot `project.json` was absent;
  a complete, tested deliverable was requested.
