...
See [okhp3-repo-settings](../.agents/skills/okhp3-repo-settings/SKILL.md) and its
[creator handoff](../.agents/skills/okhp3-repo-settings/references/creator-handoff.md).
...
[source ledger](../.agents/skills/okhp3-repo-settings/references/sources.md).
